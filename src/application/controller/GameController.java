...
import application.controller.Animator;
import ai.ClassAI;
...
import application.data.GameBoard;
...
public class GameController {
    ...
    public void backToMenuActionPerformed(ActionEvent actionEvent) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../vue/mainWindow.fxml"));
    ...
    private void doPlayerTurn(Tile tile, GameBoard gameBoard) {
        ...
        System.out.println("- " + tile.getPlayer().getName() + " choose tile: (" + tile.getX() + ", " + tile.getY() + ")");
    ...
    private void initializeGame(GameBoard gameBoard) {
        ...
        play = true;
        int rows = modeJeuController.numRow;
        int columns = modeJeuController.numColumn;

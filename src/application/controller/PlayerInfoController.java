...
import application.data.Sprite;
...
public class PlayerInfoController {
    ...
    public void nextBtnActionPerformed(ActionEvent actionEvent) throws IOException {
        ...
        loader = new FXMLLoader(getClass().getResource("../vue/game.fxml"));
    ...
    public void backBtnActionPerformed(ActionEvent actionEvent) throws IOException {
        ...
        if(DataManager.gameMode.equals("SinglePlayer"))  loader = new FXMLLoader(getClass().getResource("../vue/modeJeu.fxml"));
        else loader = new FXMLLoader(getClass().getResource("../vue/gameMode.fxml"));
